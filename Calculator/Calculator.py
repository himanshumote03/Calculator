...
# b = Button(f, text="=", padx=8.5, pady=5, font="lucida 20 bold")
# b.pack(side=LEFT, pady=5, padx=5)
# b.bind("<Button-1>", click)
# f.pack()
...
# frame 4
f = Frame(root, bg="gray")
b = Button(f, text="0", padx=10, pady=5, font="lucida 20 bold")
b.pack(side=LEFT, pady=5, padx=5)
b.bind("<Button-1>", click)

b = Button(f, text="-", padx=12, pady=5, font="lucida 20 bold")
b.pack(side=LEFT, pady=5, padx=5)
b.bind("<Button-1>", click)

b = Button(f, text="*", padx=12, pady=5, font="lucida 20 bold")
b.pack(side=LEFT, pady=5, padx=6)
b.bind("<Button-1>", click)
...
# frame 5
f = Frame(root, bg="gray")
b = Button(f, text="/", padx=12.5, pady=5, font="lucida 20 bold")
b.pack(side=LEFT, pady=5, padx=5.5)
b.bind("<Button-1>", click)
...
# frame 6
f = Frame(root, bg="gray")
b = Button(f, text="C", padx=10, pady=5, font="lucida 20 bold")
b.pack(side=LEFT, pady=5, padx=5)
b.bind("<Button-1>", click)

b = Button(f, text="+", padx=42, pady=5, font="lucida 20 bold")
b.pack(side=LEFT, pady=5, padx=5)
b.bind("<Button-1>", click)
...
# frame 7
f = Frame(root, bg="gray")
b = Button(f, text="**", padx=76, pady=5, font="lucida 20 bold")
b.pack(side=LEFT, pady=5, padx=5)
b.bind("<Button-1>", click)
f.pack()
"""
